        ...
        for rostros in resultados.multi_face_landmarks:
            ...
            for id, puntos in enumerate(rostros.landmark):
                ...
                if len(lista) == 468:  
                    ...
                    if longitud4 > 50:  
                        emocion_detectada = 'Persona Asombrada'
                    
                    elif longitud1 < 30 and longitud2 < 19 and longitud3 > 80 and longitud3 < 95 and longitud4 < 5:  
                        emocion_detectada = 'Persona Enojada'
                    
                    elif longitud1 > 10 and longitud1 < 30 and longitud2 > 20 and longitud2 < 30 and longitud3 > 80 and longitud3 < 109 and longitud4 < 5:  
                        emocion_detectada = 'Persona Triste'
                    
                    elif longitud3 > 70:  
                        emocion_detectada = 'Persona Feliz'

                    
                    if emocion_detectada:
                        cv2.putText(frame, emocion_detectada, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, 
                                   (0, 255, 0) if emocion_detectada == 'Persona Asombrada' else 
                                   (0, 0, 255) if emocion_detectada == 'Persona Enojada' else 
                                   (255, 0, 0) if emocion_detectada == 'Persona Triste' else 
                                   (0, 255, 255), 3)
